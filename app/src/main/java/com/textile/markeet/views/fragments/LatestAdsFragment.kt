...
import kotlinx.android.synthetic.main.fragment_latest_ads.*


class LatestAdsFragment(context: Context) : BaseFragment() {

    private var adsAdapter: AdsAdapter? = null
    var mcontext = context
    private val TAG = "LatestAdsFragment"
    private var expiryAdsViewModel: AdsViewModel? = null
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_latest_ads, container, false)
    ...
    private fun getlatetsAds() {


        expiryAdsViewModel?.getLatestAds(token)
